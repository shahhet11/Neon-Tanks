...
//! \cond
	...
	protected void InternalUpdate()
		...
		// Press...
			...
			{
			this.OnPress(this.pollPressStartPos, this.pollCurPos, this.pollPressStartDelay, this.pollStartedByMouse);
	...
	// -----------------
	virtual protected void OnPress(Vector2 startPos, Vector2 pos, float delay, bool startedByMouse)
		{
...
//! \cond
	...
	// -----------------
	override protected void OnPress(Vector2 startPos, Vector2 pos, float delay, bool startedByMouse)
		{
		base.OnPress(startPos, pos, delay, startedByMouse);
