		...
		public void DrawGUI()
			...
			if (InspectorUtils.DrawSectionHeader(new GUIContent("General Settings", "General Settings"), ref this.isFoldedOut))
				...
				InspectorUtils.BeginIndentedSection(new GUIContent("Visibility Settings"));
					...
					overrideActiveRig = EditorGUILayout.ToggleLeft(new GUIContent("Overrie active rig", "If unchecked, this rig will the auto-activated only if there's no active rig in the scene."),
	...
	private class AxisListInspector : ListInspector
		...
		private class AxisElemInspector : ListInspector.ElemInspector
			...
			protected override void DrawGUIContent() //object targetObj)
				...
				if ((axisType == InputRig.AxisType.Analog) || (axisType == InputRig.AxisType.Digital))
					{
				...
				if ((axisType == InputRig.AxisType.Analog) || (axisType == InputRig.AxisType.SignedAnalog) || (axisType == InputRig.AxisType.Digital))
					{
				...
				if (this.target.axisType != InputRig.AxisType.Digital)
					...
					if ((this.target.axisType == InputRig.AxisType.Analog) || (this.target.axisType == InputRig.AxisType.SignedAnalog))
						{
