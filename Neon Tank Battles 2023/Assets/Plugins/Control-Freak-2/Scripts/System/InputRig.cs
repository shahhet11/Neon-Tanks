...
//! \cond
	...
	private void BasicConstructor()
		...
		this.joysticks = new VirtualJoystickConfigCollection(this, 2);
...
//! \cond
	...
	private class EmulatedTouchState
		...
		public void Start(Vector2 pos)
			...
			this.touch.OnTouchStart(pos, pos, 0, false);
			}
	...
	public enum AxisType
		{
		Analog,			//!< Clamped analog axis (0..1). 
	...
	public class AxisConfig : NamedConfigElement
		...
		static public AxisConfig CreateAnalog(string name, KeyCode keyPositive)
			...
			o.name				= name;
			o.axisType 			= InputRig.AxisType.Analog;
			o.keyboardPositive	= keyPositive;
			o.keyboardNegative	= KeyCode.None;
		...
		override public void Update(InputRig rig)
			...
			switch (this.axisType)
				...
				case AxisType.SignedAnalog :
					...
					if ((this.axisType == InputRig.AxisType.Analog) && (rawAnalogVal < 0))
						rawAnalogVal = 0;
			...
			if ((this.analogToDigitalNegCur || frDigitalNeg))
				rig.SetKeyCode(this.affectSourceKeys ? this.keyboardNegative : this.affectedKeyNegative);

			if ((this.analogToDigitalPosCur || frDigitalPos))
				rig.SetKeyCode(this.affectSourceKeys ? this.keyboardPositive : this.affectedKeyPositive);
	...
	public class MouseConfig : IBindingContainer
		...
		private bool IsMouseDeltaActive()
			...
			return (!CF2Input.IsInMobileMode() ||  
				(UnityEngine.Input.touchSupported && UnityEngine.Input.mousePresent && 
#if !UNITY_PRE_5_0
		...
		// ------------------
		private bool IsMousePositionActive()
			{
			return (!CF2Input.IsInMobileMode() ||  
				(UnityEngine.Input.touchSupported && UnityEngine.Input.mousePresent && 
#if !UNITY_PRE_5_0
		...
		public void Update()
			...
			if (this.IsMouseDeltaActive()) //!CF2Input.IsInMobileMode() && UnityEngine.Input.mousePresent)
				{
